...
<?php 
	if(isset($_SESSION['enforced']) && $_SESSION['enforced'] == True) {
		echo '<p><font color="red">Please spend more time watching the full excerpt. Click the arrow when you are finished to continue.</font><a href="tv2.php"><img src="../nextArrow.gif"></a></p>';
	}
	else {
		echo '<p>Click on the arrow when you are done viewing the media. <a href="tv2.php"><img src="../nextArrow.gif"></a></p>';
	}
?>
<div id = 'container'>
	<div id = 'video'>
		<object width='800' height='480'><param name='movie' value='http://www.youtube.com/v/26HZ2piqvf0?version=3&amp;hl=en_US&amp;rel=0&amp;showinfo=0&amp;controls=0&amp;modestbranding=1&amp;autoplay=1&disablekb=1'></param>
		<param name='allowFullScreen' value='true'>
		</param><param name='allowscriptaccess' value='always'>
		</param><embed src='http://www.youtube.com/v/26HZ2piqvf0?version=3&amp;hl=en_US&amp;rel=0&amp;showinfo=0&amp;controls=0&amp;modestbranding=1&amp;autoplay=1&disablekb=1' type='application/x-shockwave-flash' width='800' height='480' allowscriptaccess='always' allowfullscreen='true'>
		</embed></object>
	</div>
	<div id = 'tvbackground'>
